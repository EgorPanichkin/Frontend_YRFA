import { ChevronLeft, CustomButton, SelectComponent, Typography } from '@/shared'
  ...
  return (
    <form className={style.registerForm} onSubmit={handleSubmit}>
      <div className={style.registerBlockTitle}>
        <ChevronLeft className={style.registerBack} width={24} onClick={() => navigate(-1)} />
      ...
      <CustomButton type='submit' disabled={isDisabled}>
        <Typography>Создать кабинет пациента</Typography>
      </CustomButton>
    </form>
  )
}
