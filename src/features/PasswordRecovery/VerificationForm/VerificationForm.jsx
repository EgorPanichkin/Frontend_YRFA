import { ChevronLeft, CustomButton, InputComponent, ModalWrapper, PhoneIcon, Typography } from '@/shared'
...
export const VerificationForm = () => {
  ...
  const verificationData = useSelector((state) => state.verificationData.verificationData)
  ...
  return (
    <form className={style.smsForm} onSubmit={handleSubmit}>
      ...
      <a className={style.smsFormLink} onClick={() => setNotificationPhone(!notificationPhone)}>
        Не получили код?
      </a>
      {notificationPhone && (
