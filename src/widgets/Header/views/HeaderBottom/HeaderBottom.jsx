import { Container, CustomButton, Logo, Typography, UserCircleIcon, navigationHeaderLinks } from '@/shared'
      ...
      <div className={style.navigation}>
        ...
        <nav>
          <div className={style.main}>
            <DropdownHeaderMenu items={navigationHeaderLinks.main.items} title={navigationHeaderLinks.main.title} />
            <DropdownHeaderMenu
              items={navigationHeaderLinks.services.items}
              title={navigationHeaderLinks.services.title}
            />
            <DropdownHeaderMenu items={navigationHeaderLinks.more.items} title={navigationHeaderLinks.more.title} />
          </div>
